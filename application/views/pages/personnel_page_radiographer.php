        ...
        <?php } ?>
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="card" id="patients-awaiting-radiographer-card-edit" style="<?php if($sixth_addition != "edit"){ echo "display: none"; } ?> ">
                <div class="card-header">
                  <button onclick="goBackFromPatientsAwaitingRadiographerCardEdit(this,event)" class="btn btn-warning">Go Back</button>
                  <h3 class="card-title">Previously Processed Results</h3>
                </div>
                <div class="card-body">
                <?php
                  ...
                  if(isset($rows)){
                    ...
                    if(is_array($initiation_codes)){
                      ...
                      foreach($initiation_codes as $row){
                        ...
                        $tests_num = $this->onehealth_model->getTestsNumForPatientAwaitingRadiographerEdit($health_facility_id,$initiation_code,$sub_dept_id);
              ...
              <div class="card" id="patients-awaiting-radiographer-card" style="<?php if($sixth_addition != "enter"){ echo "display: none"; } ?> ">
                <div class="card-header">
                  ...
                  if(isset($rows)){
                    ...
                    if(is_array($initiation_codes)){
                      ...
                      foreach($initiation_codes as $row){
                        ...
                        $tests_num = $this->onehealth_model->getTestsNumForPatientAwaitingRadiographer($health_facility_id,$initiation_code,$sub_dept_id);
...
<script>
    $(document).ready(function() {
      ...
      $("#patients-awaiting-radiographer-card-edit #filter-rows-form").submit(function (evt) {
        evt.preventDefault()
        var me  = $(this)
      ...
      $("#patients-awaiting-radiographer-card-edit #clear-filter-rows-form").click(function(evt){
        var me = $(this);
        $("#patients-awaiting-radiographer-card-edit #filter-rows-form input").val("")
        
      })
      
      $("#patients-awaiting-radiographer-card #filter-rows-form").submit(function (evt) {
        evt.preventDefault()
        var me  = $(this)
        var form_data = me.serializeArray()
        // var full_name = me.find("#full_name").val()
      ...
      $("#patients-awaiting-radiographer-card #clear-filter-rows-form").click(function(evt){
        var me = $(this);
        $("#patients-awaiting-radiographer-card #filter-rows-form input").val("")
