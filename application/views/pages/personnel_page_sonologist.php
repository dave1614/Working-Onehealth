                  ...
                  if(isset($rows)){
                    ...
                    if(is_array($initiation_codes)){
                      ...
                      foreach($initiation_codes as $row){
                        ...
                        $tests_num = $this->onehealth_model->getTestsNumForPatientAwaitingSonologistEdit($health_facility_id,$initiation_code,$sub_dept_id);
                  ...
                  if(is_array($initiation_codes)){
                    ...
                    foreach($initiation_codes as $row){
                      ...
                      $initiation_code = $row->initiation_code;
                        ...
                        $tests_num = $this->onehealth_model->getTestsNumForPatientAwaitingSonologist($health_facility_id,$initiation_code,$sub_dept_id);
