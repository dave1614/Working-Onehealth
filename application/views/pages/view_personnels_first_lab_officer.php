    ...
    ?>
      <script>
        function deletePersonnel(elem,evt,personnel_officers_id){
          evt.preventDefault();
          swal({
              title: 'Warning',
      ...
      <div class="content">
        <div class="container-fluid">
          ...
          <span style="text-transform: capitalize; font-size: 13px;" ><a class="text-info" href="<?php echo site_url('onehealth/index/'.$health_facility_slug.'/'.$dept_slug.'/admin') ?>"><?php echo $dept_name; ?></a> &nbsp;&nbsp; > >  <?php echo $first_officer_name; ?></span>
          
          <h3 style="text-transform: capitalize;" class="text-center"><?php echo $first_officer_name; ?></h3>
              ...
              <div class="card">
                <div class="card-header card-header-blue card-header-icon">
                  ...
                  <div class="card-title">
                    <h4 style="text-transform: capitalize;">Personnel In <em class="text-primary"><?php echo $first_officer_name; ?></em></h4>
                  </div>
                </div>
                <div class="card-body">
                  <?php
                    $personnel_arr = $this->onehealth_model->getLabFirstOfficersPersonnelForFacility($health_facility_id,$first_officer_id);
                  ...
                  <?php
                      ...
                      echo "<h4 class='text-warning'>You Have No Personnel Here</h4>";
                    }
                  ?>
                </div>
              </div>
