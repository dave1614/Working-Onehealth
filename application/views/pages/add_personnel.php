      ...
      <div class="content">
        <div class="container-fluid">
          ...
          <?php  } ?>
          <h3 style="text-transform: capitalize;" class="text-center"><?php echo $personnel_name; ?></h3>
          <a href="<?php echo site_url('onehealth/index/'.$health_facility_slug.'/'.$dept_slug.'/'.$sub_dept_slug.'/admin') ?>" class="btn btn-warning">Go Back</a>
          <div class="row">
            <div class="col-sm-8 col-center">
             ...
             <div class="card" style="display: none;" id="add-new-personnel-card">
               ...
               <div class="card-body">
                 ...
                 <?php echo form_open('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition.'/'.$fourth_addition.'/add_new_personnel',$attr); ?>
        ...
        $.ajax({
          ...
          success : function (response) {
            ...
            if(response.success == true){
              ...
              var text_val = "<h4 style='text-transform: capitalize;'>You Have Successfully Added A Personnel As <?php echo $personnel_name ?> with the following details</h4>";
