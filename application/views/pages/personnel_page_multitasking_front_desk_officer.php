...
<script>
  ...
  function chooseThisLabToPerformFunction(elem,evt,url,lab_name,sub_dept_id){
    ...
    $("#choose-function-to-perform-card .card-title").html("Select Functionality To Perform In " + lab_name);
    $("#choose-function-to-perform-card").show();
    $("#choose-lab-to-perform-functions-card").hide();
  }
                  ...
                  <table class="table">
                    <tbody>
                      ...
                      foreach($all_labs as $row){
                        ...
                        $personnel_slug = "multitasking-front-desk-officer";
