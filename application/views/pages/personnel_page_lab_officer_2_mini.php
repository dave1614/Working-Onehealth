...
<script>
  ...
  function inputTestValues (elem,evt) {
    var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/admin/view_patients_ready_for_inputing_of_result_mini'); ?>"
  ...
  function viewPreviousResults (elem,evt) {
    var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/admin/view_patients_ready_for_editing_of_results_mini'); ?>"
        ...
        <?php } ?>
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="card" id="edit-results-card" style="<?php if($sixth_addition != "view_patients_ready_for_editing_of_results_mini"){ echo "display: none;"; }  ?>">
                <div class="card-header">
                ...
                <?php
                  ...
                  if(isset($rows)){
                    ...
                    if(is_array($initiation_codes)){
                      ...
                      $response_arr['messages'] .= '<table id="edit-results-table" class="table table-test table-striped table-bordered nowrap hover display" id="process-sample-table" cellspacing="0" width="100%" style="width:100%">';
                      ...
                      $response_arr['messages'] .= '<th>Test Ready Time</th>';
                      ...
                      foreach($initiation_codes as $row){
                        ...
                        $tests_num = $this->onehealth_model->getTestsNumForPatientValidForEditingOfResultsMini($health_facility_id,$initiation_code);

                        $sampling_time = $this->onehealth_model->getLabFacilityParamByInitiationCodeAndHealthFacilityId("sampling_time",$initiation_code,$health_facility_id);

                        $seperation_time = $this->onehealth_model->getLabFacilityParamByInitiationCodeAndHealthFacilityId("seperation_time",$initiation_code,$health_facility_id);

                        $test_completed_time = $this->onehealth_model->getLabFacilityParamByInitiationCodeAndHealthFacilityId("test_completed_time",$initiation_code,$health_facility_id);
                        ...
                        $response_arr['messages'] .= '<td>'.$test_completed_time.'</td>';
                        $response_arr['messages'] .= '</tr>';
              ...
              <div class="card" id="input-results-card" style="<?php if($sixth_addition != "view_patients_ready_for_inputing_of_result_mini"){ echo "display: none;"; }  ?>">
                <div class="card-header">
                ...
                <?php
                  ...
                  if(isset($rows)){
                    ...
                    if(is_array($initiation_codes)){
                      ...
                      $response_arr['messages'] .= '<th>Initiation Code</th>';
                      $response_arr['messages'] .= '<th>Lab Id</th>';
                      $response_arr['messages'] .= '<th>Sampling Time</th>';
                      $response_arr['messages'] .= '<th>Seperation Time</th>';
                      $response_arr['messages'] .= '</tr>';
                      $response_arr['messages'] .= '</thead>';
                      $response_arr['messages'] .= '<tbody>';
                      ...
                      foreach($initiation_codes as $row){
                        ...
                        $tests_num = $this->onehealth_model->getTestsNumForPatientValidForInputingOfResultsMini($health_facility_id,$initiation_code);
                        ...
                        $response_arr['messages'] .= '<td>'.$initiation_code.'</td>';
                        $response_arr['messages'] .= '<td>'.$lab_id.'</td>';
                        $response_arr['messages'] .= '<td>'.$sampling_time.'</td>';
                        $response_arr['messages'] .= '<td>'.$seperation_time.'</td>';
                        $response_arr['messages'] .= '</tr>';
              ...
              <div class="card" id="main-card" style="<?php if($sixth_addition == 'view_patients_ready_for_inputing_of_result_mini' || $sixth_addition == "view_patients_ready_for_editing_of_results_mini"){ echo "display: none;"; }  ?>">
                <div class="card-header">
...
<script>
    $(document).ready(function() {
      ...
      $("#edit-results-card #filter-rows-form").submit(function (evt) {
        evt.preventDefault()
        var me  = $(this)
        ...
        var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/admin/view_patients_ready_for_editing_of_results_mini'); ?>?lab_id="+lab_id+"&initiation_code="+initiation_code
        

        window.location.assign(url)
      })

      $("#edit-results-card #clear-filter-rows-form").click(function(evt){
        var me = $(this);
        $("#edit-results-card #filter-rows-form input").val("")
        
      })


      $("#input-results-card #filter-rows-form").submit(function (evt) {
        evt.preventDefault()
        var me  = $(this)
        var form_data = me.serializeArray()
        // var full_name = me.find("#full_name").val()
        ...
        var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/admin/view_patients_ready_for_inputing_of_result_mini'); ?>?lab_id="+lab_id+"&initiation_code="+initiation_code
        

        window.location.assign(url)
      })

      $("#input-results-card #clear-filter-rows-form").click(function(evt){
        var me = $(this);
        $("#input-results-card #filter-rows-form input").val("")
