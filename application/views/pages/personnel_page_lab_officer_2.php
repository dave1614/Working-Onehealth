...
<script>
  ...
  function inputTestValues (elem,evt) {
    ...
    var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/admin/view_patients_ready_for_inputing_of_result_standard'); ?>"
        ...
        <?php } ?>
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="card" id="input-results-card" style="<?php if(is_null($sixth_addition)){ echo "display: none;"; }  ?>">
                <div class="card-header">
                  ...
                  if(isset($rows)){
                    ...
                    if(is_array($initiation_codes)){
                      ...
                      foreach($initiation_codes as $row){
                        ...
                        $tests_num = $this->onehealth_model->getTestsNumForPatientValidForInputingOfResultsStandardOrMaximum($health_facility_id,$initiation_code,$sub_dept_id);
              ...
              <div class="card" id="main-card" style="<?php if($sixth_addition == 'view_patients_ready_for_inputing_of_result_standard'){ echo "display: none;"; }  ?>">
                <div class="card-header">
...
<script>
    $(document).ready(function() {
       ...
       $("#filter-rows-form").submit(function (evt) {
        ...
        var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/admin/view_patients_ready_for_inputing_of_result_standard'); ?>?lab_id="+lab_id+"&initiation_code="+initiation_code
