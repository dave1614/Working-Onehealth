...
<script>
  ...
  function viewTestsAwaitingVerification (elem,evt) {
    var url = "<?php echo site_url('onehealth/index/'.$addition.'/'.$second_addition.'/'.$third_addition. '/' . $fourth_addition .'/admin/view_patients_awaiting_verification_of_results'); ?>"
        ...
        <?php } ?>
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <div class="card" id="main-card" style="<?php if($sixth_addition == 'view_patients_awaiting_verification_of_results'){ echo "display: none;"; }  ?>">
              ...
              <div class="card" id="patients-awaiting-verification-card" style="<?php if(is_null($sixth_addition)){ echo "display: none;"; }  ?>">
                <div class="card-header">
                ...
                <?php
                  ...
                  if(isset($rows)){
                    ...
                    if(is_array($initiation_codes)){
                      ...
                      $response_arr['messages'] .= '<th>Results Inputed Time</th>';
                      ...
                      foreach($initiation_codes as $row){
                        ...
                        $tests_num = $this->onehealth_model->getTestsNumForPatientAwaitingVerification($health_facility_id,$initiation_code,$sub_dept_id);
