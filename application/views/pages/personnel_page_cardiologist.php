                  ...
                  if(isset($rows)){
                    ...
                    if(is_array($initiation_codes)){
                      ...
                      foreach($initiation_codes as $row){
                        ...
                        $tests_num = $this->onehealth_model->getTestsNumForPatientAwaitingCardiologist($health_facility_id,$initiation_code,$sub_dept_id);
                  ...
                  if(isset($rows)){
                    ...
                    if(is_array($initiation_codes)){
                      ...
                      foreach($initiation_codes as $row){
                        ...
                        $tests_num = $this->onehealth_model->getTestsNumForPatientAwaitingCardiologistEdit($health_facility_id,$initiation_code,$sub_dept_id);
